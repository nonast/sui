...
/// The Epoch Manifest is stored in a custom binary format, starting with a magic number, and
/// ending with a digest, and the contents in between is BCS-serialized, with the following
/// structure.
